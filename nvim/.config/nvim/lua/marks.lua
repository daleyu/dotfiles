-- Borrowed from https://github.com/MariaSolOs/dotfiles/blob/4104920aab4156aa72a6810728ebd16d8f201214/.config/nvim/lua/marks.lua

local ns = vim.api.nvim_create_namespace 'daleyu/marks'
