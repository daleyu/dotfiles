...
vim.api.nvim_create_autocmd('LspAttach', {
	...
	callback = function(event)
		...
		vim.keymap.set("n", "go", function() Snacks.picker.lsp_type_definitions() end, opts)
		vim.keymap.set("n", "gr", function() Snacks.picker.lsp_references() end, opts)
		vim.keymap.set("n", "<leader>ge", function() Snacks.picker.diagnostics_buffer() end, opts)
		vim.keymap.set("n", "<leader>gw", function() Snacks.picker.diagnostics() end, opts)
		vim.keymap.set("n", "<leader>gl", function() Snacks.picker.resume() end, opts)
